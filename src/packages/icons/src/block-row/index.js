export default <svg width="20px" height="20px" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" fillRule="evenodd"
	...
	<path
		...
		fill="var(--kadence-color, #0058b0 )" fillRule="nonzero"/>
	<rect x="4.587" y="11.533" width="38.825" height="18.096" fill="var(--kadence-color, #0058b0 )"
	/>
	...
	<path
		...
		fill="var(--kadence-color, #0058b0 )" fillRule="nonzero" stroke="var(--kadence-color-white, #ffffff )" strokeWidth="1.76"/>
	<path
		...
		fill="var(--kadence-color-white, #ffffff )" fillRule="nonzero"/>
</svg>;
