 ...
 */
export default function setDynamicState( filter, content, attributes, dynamicAttribute, setAttributes, setState, context ) {
    if ( attributes.kadenceDynamic && attributes.kadenceDynamic[dynamicAttribute] && attributes.kadenceDynamic[dynamicAttribute].enable ) {
        applyFilters( filter, content, attributes, dynamicAttribute, setAttributes, setState, context );
    }
}