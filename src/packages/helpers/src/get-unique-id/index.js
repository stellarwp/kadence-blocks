 ...
 */
export default function getUniqueId( uniqueID, clientId, isUniqueID, isUniqueBlock, blockPostId = '', uniqueWhenRegenerate = false ) {
	...
	if ( ! uniqueID || ( hasBlockPostIdPrefix && uniqueID.split('_')[0] !== blockPostId.toString() ) ) {
		...
		return uniqueWhenRegenerate ? uniqueId( smallID ) : smallID;
	}
