...
export default function getPostIdOrFseSlug( props, parentPostData ) {

	const { postId, reusableCheck, rootBlock, editedPostId } = parentPostData;
	const id = getPostOrWidgetId( props,  postId, reusableCheck, 0 );
