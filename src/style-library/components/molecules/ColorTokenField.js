...
export function ColorTokenField({ token, value, onSave, fieldState }) {
	...
	return (
		<div className="kadence-blocks-style-library__token-field kadence-blocks-style-library__token-field--color">
			<div className="kadence-blocks-style-library__token-field-meta">
				<Dropdown
					...
					renderToggle={({ isOpen, onToggle }) => (
						<button
							type="button"
							className="kadence-blocks-style-library__color-picker-toggle"
					...
					renderContent={() => (
						<div className="kadence-blocks-style-library__color-picker-popover">
							<ColorPicker
