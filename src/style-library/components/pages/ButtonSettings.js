/**
 * The Button preset's settings panel: `PresetSettings` does the work, this binds the block's
 * config to it.
 */
...
export function ButtonSettings({ route, navigate, library }) {
	...
	return <PresetSettings route={route} navigate={navigate} screen={screen} preset={BUTTON_PRESET} />;
}
