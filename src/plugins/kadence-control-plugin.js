				...
				>
					<div className="kt-blocks-control-wrap">
						...
						<div className="kt-blocks-control-row">
							...
							{'admin' === user && (
								<KadenceVisibilitySettings blockName={'Accordion'} blockSlug={'accordion'} options={[
									...
									{ key: 'titleSpacing', label: __( 'Enable Title Spacing Settings', 'kadence-blocks' ) },
									{ key: 'titleBorder', label: __( 'Enable Title Border Settings', 'kadence-blocks' ) },
									{ key: 'titleFont', label: __( 'Enable Title Font Settings', 'kadence-blocks' ) },
									{ key: 'paneContent', label: __( 'Enable Inner Content Settings', 'kadence-blocks' ) },
						...
						<div className="kt-blocks-control-row">
							...
							{'admin' === user && (
								<KadenceVisibilitySettings blockName={'Advanced Button'} blockSlug={'advancedbtn'} options={[
									...
									{ key: 'fontSettings', label: __( 'Enable Font Family Settings', 'kadence-blocks' ) },
								]}/>
							)}
						</div>
						...
						<div className="kt-blocks-control-row">
							...
							{'admin' === user && (
								<KadenceVisibilitySettings blockName={'Advanced Gallery'} blockSlug={'advancedgallery'} options={[
									...
									{ key: 'captionSettings', label: __( 'Enable Caption Settings', 'kadence-blocks' ) },
									{ key: 'shadowSettings', label: __( 'Enable Image Shadow Settings', 'kadence-blocks' ) },
									{ key: 'spacingSettings', label: __( 'Enable Gallery Spacing Settings', 'kadence-blocks' ) },
								]}/>
							)}
						</div>
						...
						<div className="kt-blocks-control-row">
							<KadenceHeadings/>
							{'admin' === user && (
								<KadenceVisibilitySettings blockName={'Advanced Text'} blockSlug={'advancedheading'} options={[
									{ key: 'toolbarTypography', label: __( 'Enable Typography Settings in Toolbar', 'kadence-blocks' ) },
									{ key: 'toolbarColor', label: __( 'Enable Color Settings in Toolbar', 'kadence-blocks' ) },
									{ key: 'colorSettings', label: __( 'Enable Color Settings', 'kadence-blocks' ) },
									{ key: 'sizeSettings', label: __( 'Enable Size Settings', 'kadence-blocks' ) },
									{ key: 'advancedSettings', label: __( 'Enable Advanced Typography Settings', 'kadence-blocks' ) },
									{ key: 'highlightSettings', label: __( 'Enable Highlight Settings', 'kadence-blocks' ) },
									{ key: 'marginSettings', label: __( 'Enable Margin Settings', 'kadence-blocks' ) },
								]}/>
							)}
						</div>
						...
						<div className="kt-blocks-control-row">
							...
							{'admin' === user && (
								<KadenceVisibilitySettings blockName={'Row Layout'} blockSlug={'rowlayout'} options={[
									...
									{ key: 'backgroundOverlay', label: __( 'Enable Background Overlay Settings', 'kadence-blocks' ) },
						...
						<div className="kt-blocks-control-row">
							...
							{'admin' === user && (
								<KadenceVisibilitySettings blockName={'Section'} blockSlug={'container'} options={[
									...
									{ key: 'paddingMargin', label: __( 'Enable Padding/Margin Control', 'kadence-blocks' ) },
								]}/>
							)}
						</div>
						...
						<div className="kt-blocks-control-row">
							...
							{'admin' === user && (
								<KadenceVisibilitySettings blockName={'Spacer / Divider'} blockSlug={'spacer'} options={[
									...
									{ key: 'dividerStyles', label: __( 'Enable Divider Styles Control', 'kadence-blocks' ) },
								]}/>
							)}
						</div>
						...
						<div className="kt-blocks-control-row">
							...
							{'admin' === user && (
								<KadenceVisibilitySettings blockName={'Tabs'} blockSlug={'tabs'} options={[
									...
									{ key: 'titleSpacing', label: __( 'Enable Title Spacing/Border Settings', 'kadence-blocks' ) },
									{ key: 'titleFont', label: __( 'Enable Title Font Settings', 'kadence-blocks' ) },
						...
						<div className="kt-blocks-control-row">
							...
							{'admin' === user && (
								<KadenceVisibilitySettings blockName={'Testimonials'} blockSlug={'testimonials'} options={[
									...
									{ key: 'containerSettings', label: __( 'Enable Container Settings', 'kadence-blocks' ) },
									{ key: 'carouselSettings', label: __( 'Enable Carousel Settings', 'kadence-blocks' ) },
									...
									{ key: 'occupationSettings', label: __( 'Enable Occupation Settings', 'kadence-blocks' ) },
									{ key: 'shadowSettings', label: __( 'Enable Shadow Settings', 'kadence-blocks' ) },
									{ key: 'individualSettings', label: __( 'Enable Individual Item Settings', 'kadence-blocks' ) },
								]}/>
							)}
						</div>
						{map( blocks, ( { Control } ) => (
						...
						<KadenceVisibilitySettings blockName={'Design Library'} blockSlug={'designlibrary'} showBlockWideSettings={false}
												   options={[
													   ...
													   { key: 'section', label: __( 'Show Sections Library For', 'kadence-blocks' ), requiresPro: true },
													   { key: 'templates', label: __( 'Show Starter Packs Library For', 'kadence-blocks' ), requiresPro: true },
												   ]}/>
