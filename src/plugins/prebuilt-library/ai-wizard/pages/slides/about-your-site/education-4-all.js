...
const content = [
  `Education 4All is a non-profit organization dedicated to providing 
  underprivileged children with access to quality education.`,
  `Through initiatives like school infrastructure development, teacher 
  training, curriculum development, and learning resource provision, we empower 
  children, their families, and communities.`,
  `Our mission is to break the cycle of poverty by equipping children with the 
