				...
				>
					<FlexBlock style={ styles.formWrapper } className={ 'stellarwp-body' }>
						<VStack spacing={ 6 } style={{ margin: '0 auto' }}>
							...
							<CheckboxControl
								label={ __('Excitingly, the content is generated by OpenAI! However, please double-check everything before publishing, as we can\'t take responsibility for any unintended output. Happy creating!', 'kadence-blocks') }
