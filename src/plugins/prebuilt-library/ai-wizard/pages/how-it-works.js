...
const content2 = __(
	'Forget about learning AI - just tell us about yourself, and let Kadence AI take care of the rest. Say goodbye to blank screen anxiety. Welcome effective content that represents your brand.',
	'kadence-blocks'
);
...
export function HowItWorks() {
	return (
		<Flex style={styles.background}>
			<Flex gap={22.5}>
				<FlexBlock>
					<Flex className={'inner'} justify="end">
				...
				<FlexBlock style={styles.imageWrapper}>
					<img src={AiModalIntro} style={styles.image} />
				</FlexBlock>
			</Flex>
		</Flex>
	);
