...
import { BaseControl, Button, FlexBlock, FlexItem, withFocusOutside } from '@wordpress/components';
import SuggestionsList from '@wordpress/components/form-token-field/suggestions-list';
import TokenInput from '@wordpress/components/form-token-field/token-input';
...
// import { ComboboxControl as CoreComboboxControl, Icon } from '@wordpress/components';
...
//
//   return <CoreComboboxControl className={ `stellarwp ${ className }` } prefix={ <Icon icon={ search } /> } { ...rest } />;
// }
...
const getIndexOfMatchingSuggestion = ( selectedSuggestion, matchingSuggestions ) => {
