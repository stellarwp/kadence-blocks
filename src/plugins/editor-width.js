...
const icon = <svg width="20" height="20" viewBox='0 0 40 40' xmlns='http://www.w3.org/2000/svg' fillRule='evenodd'
clipRule='evenodd' strokeLinejoin='round' strokeMiterlimit='1.414'>
    ...
    <path d='M8.974,22.895l0,2.592l-3.988,-3.988l3.988,-3.987l0,2.592l22.052,0l0,-2.592l3.988,3.987l-3.988,3.988l0,-2.592l-22.052,0Z'
    fill='#555d66' />
</svg>;
...
function CustomComponent({ meta, oldMeta, onUpdateBananas, onUpdateWhy, onSelect }) {
	return (
		<Fragment>
			...
			>
				...
				<TextControl
					...
					value={ meta.jsforwpblocks_gb_metabox }
					onChange={ value => onUpdateWhy( value, meta, oldMeta ) }
				/>
			</PluginSidebar>
		</Fragment>
	);
...
const plugin = compose([
	...
	withDispatch((dispatch) => ({
		onUpdateBananas(value, newMeta, oldMeta) {
			const meta = {
		...
		onUpdateWhy(value, newMeta, oldMeta) {
			const meta = {
				...reviseData(oldMeta, newMeta),
				jsforwpblocks_gb_metabox: value,
			};

			dispatch("core/editor").editPost({ meta })
		},
		onSelect(attachment, newMeta, oldMeta) {
			const meta = {
				...reviseData(newMeta, oldMeta),
				myVideoId: attachment.id,
				myVideoURL: attachment.url,
			}  
