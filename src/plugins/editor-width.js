...
const icon = (
	...
	>
		...
		<path
			d="M8.974,22.895l0,2.592l-3.988,-3.988l3.988,-3.987l0,2.592l22.052,0l0,-2.592l3.988,3.987l-3.988,3.988l0,-2.592l-22.052,0Z"
			fill="#555d66"
		/>
	</svg>
);
...
function CustomComponent({ meta, oldMeta, onUpdateWidth }) {
	...
	const block_editor_width =
		undefined !== meta && undefined !== meta.kt_blocks_editor_width ? meta.kt_blocks_editor_width : '';
	return (
