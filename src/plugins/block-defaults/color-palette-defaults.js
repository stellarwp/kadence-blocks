...
function KadenceColorDefault(props) {
    ...
    const [kadenceColors, setKadenceColors] = useState((kadence_blocks_params.colors ? JSON.parse(kadence_blocks_params.colors) : {
        palette: [],
        override: false
    }));
        ...
        <div className="kt-block-default-palette">
            {colors && (
                <div className={`components-color-palette palette-comp-${classSat}`}>
                    ...
                    {undefined !== kadenceColors.palette && undefined !== kadenceColors.palette[colorRemove] && !props.disableCustomColors && (
            ...
            {undefined !== kadenceColors.palette && undefined !== kadenceColors.palette[0] && !props.disableCustomColors && (
                <Fragment>
                    <ToggleControl
                    ...
                    />
                    {undefined !== kadenceColors.override && false === kadenceColors.override && true === showMessage && (
