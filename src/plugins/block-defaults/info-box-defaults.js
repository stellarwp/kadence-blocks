...
function KadenceInfoBoxDefault(props) {
    ...
    useEffect(() => {
        ...
        if (infoConfig.mediaStyle && infoConfig.mediaStyle[0]) {
			setMediaBorderControl( linkedOrIndividual( infoConfig.mediaStyle[0], 'borderWidth' ) );
			setMediaPaddingControl( linkedOrIndividual( infoConfig.mediaStyle[0], 'padding' ) );
			setMediaMarginControl( linkedOrIndividual( infoConfig.mediaStyle[0], 'margin' ) );
        }

        if (infoConfig.containerBorderWidth && infoConfig.containerBorderWidth[0]) {
			setContainerBorderControl( linkedOrIndividual( infoConfig, 'containerBorderWidth' ) );
        }
        if (infoConfig.containerPadding && infoConfig.containerPadding[0]) {
			setContainerPaddingControl( linkedOrIndividual( infoConfig, 'containerPadding' ) );
        }
    }, []);
    ...
    const saveMediaImage = (value) => {
        ...
        saveConfigState('mediaImage', newUpdate);
    };
    ...
    const saveMediaIcon = (value) => {
        ...
        saveConfigState('mediaIcon', newUpdate);
    };
    ...
    const saveMediaStyle = (value) => {
        ...
        saveConfigState('mediaStyle', newUpdate);
    };
    ...
    const saveTextFont = (value) => {
        ...
        saveConfigState('textFont', newUpdate);
    };
    ...
    const saveLearnMoreStyles = (value) => {
        ...
        saveConfigState('learnMoreStyles', newUpdate);
    };
    ...
    const saveHoverShadow = (value) => {
        ...
        saveConfigState('shadowHover', newUpdate);
    };
    return (
        <Fragment>
            ...
            {isOpen && (
                <Modal
                    ...
                    onRequestClose={() => {
                        saveConfig('kadence/infobox', infoConfig);
                    }}>
                    <PanelBody>
                        <ToggleControl
                        ...
                        <SelectControl
                            ...
                            onChange={value => saveConfigState('target', value)}
                        />
                        <SelectControl
                            ...
                            onChange={value => saveConfigState('linkProperty', value)}
                        />
                        <SelectControl
                                            ...
                                            tabout = (
                                                <Fragment>
                                                    ...
                                                    <PopColorControl
                                                        ...
                                                        onChange={value => saveConfigState('containerHoverBackground', value)}
                                                    />
                                                    <h2>{__('Container Hover Border')}</h2>
                                                    <PopColorControl
                                                        value={(undefined !== infoConfig.containerHoverBorder ? infoConfig.containerHoverBorder : '#eeeeee')}
                                                        onChange={value => saveConfigState('containerHoverBorder', value)}
                                                    />
                                                </Fragment>
                                            );
                                        } else {
                    ...
                    >
                        <SelectControl
                            ...
                            onChange={value => saveConfigState('mediaAlign', value)}
                        />
                        <SelectControl
                            label={__('Media Type')}
                            ...
                            onChange={value => saveConfigState('mediaType', value)}
                        />
                                ...
                                <SelectControl
                                    ...
                                    options={[
                                        ...
                                        {value: 'drawborder', label: __('Border Spin In')},
                                        {
                                            ...
                                            label: __('Grayscale to Color & Border Spin In')
                                        },
                                                ...
                                                if ('hover' === tab.name) {
                                                    tabout = (
                                                        <PopColorControl
                                                            ...
                                                            onChange={value => saveConfigState('titleHoverColor', value)}
                                                        />
                                                    );
                                                } else {
                                                    tabout = (
                    ...
                    >
                        <ToggleControl
                            ...
                            onChange={(value) => saveConfigState('displayText', value)}
                        />
                                                ...
                                                if ('hover' === tab.name) {
                                                    tabout = (
                                                        <PopColorControl
                                                            ...
                                                            onChange={value => saveConfigState('textHoverColor', value)}
                                                        />
                                                    );
                                                } else {
                                                    tabout = (
                    ...
                    >
                        <ToggleControl
                            ...
                            onChange={(value) => saveConfigState('displayLearnMore', value)}
                        />
                    ...
                    <div className="kb-modal-footer">
                        {!resetConfirm && (
                            <Button className="kt-defaults-save" isDestructive
                                    disabled={(JSON.stringify(configuration['kadence/infobox']) === JSON.stringify({}) ? true : false)}
                                    onClick={() => {
                        ...
                        <Button className="kt-defaults-save" isPrimary onClick={() => {
                            saveConfig('kadence/infobox', headingConfig);
                        }}>
