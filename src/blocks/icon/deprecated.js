...
const v8 = {
	...
	save({ attributes }) {
				...
				<div className={`kt-svg-style-${icons[index].style} kt-svg-icon-wrap kt-svg-item-${index}`}>
					{icons[index].icon && icons[index].link && (
						<a
							...
							aria-label={
								undefined !== icons[index].linkTitle && '' !== icons[index].linkTitle
									? icons[index].linkTitle
									: undefined
							}
						>
							<IconSpanTag
								...
								strokeWidth={
									'fe' === icons[index].icon.substring(0, 2) ? icons[index].width : undefined
								}
		...
		return <div {...blockProps}>{times(iconCount, (n) => renderSaveIcons(n))}</div>;
	},
};
const oldAttributes = {
	icons: {
...
const v7 = {
	...
	save: ({ attributes }) => {
						...
						>
							<IconRender
								...
								style={{
									...
									backgroundColor:
										icons[index].background && icons[index].style !== 'default'
											? KadenceColorOutput(icons[index].background)
											: undefined,
									padding:
										icons[index].padding && icons[index].style !== 'default'
											? icons[index].padding + 'px'
											: undefined,
									borderColor:
										icons[index].border && icons[index].style !== 'default'
											? KadenceColorOutput(icons[index].border)
											: undefined,
									borderWidth:
										icons[index].borderWidth && icons[index].style !== 'default'
											? icons[index].borderWidth + 'px'
											: undefined,
									borderRadius:
										icons[index].borderRadius && icons[index].style !== 'default'
											? icons[index].borderRadius + '%'
											: undefined,
								}}
							/>
						</a>
		...
		return (
			<div
				className={`kt-svg-icons kt-svg-icons${uniqueID} align${blockAlignment ? blockAlignment : 'none'}${
					verticalAlignment ? ' kb-icon-valign-' + verticalAlignment : ''
				}`}
				style={{
