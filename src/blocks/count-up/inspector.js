			...
			<Fragment>
				<InspectorControls>
						...
						/>
						{
							...
							<Fragment>
								...
								<ResponsiveAlignControls
									...
									value={ ( titleAlign['desktop'] ? titleAlign['desktop'] : '' ) }
									mobileValue={ ( titleAlign['mobile'] ? titleAlign['mobile'] : '' ) }
									tabletValue={ ( titleAlign['tablet'] ? titleAlign['tablet'] : '' ) }
									onChange={ ( nextAlign ) => setAttributes( { titleAlign: { ...titleAlign, desktop: nextAlign } } ) }
									onChangeTablet={ ( nextAlign ) => setAttributes( { titleAlign: { ...titleAlign, tablet: nextAlign } } ) }
									onChangeMobile={ ( nextAlign ) => setAttributes( { titleAlign: { ...titleAlign, mobile: nextAlign } } ) }
								/>
					...
					<PanelBody
						...
						<ResponsiveAlignControls
							label={ __( 'Text Alignment', 'kadence-blocks' ) }
							value={ ( numberAlign['desktop'] ? numberAlign['desktop'] : '' ) }
							mobileValue={ ( numberAlign['mobile'] ? numberAlign['mobile'] : '' ) }
							tabletValue={ ( numberAlign['tablet'] ? numberAlign['tablet'] : '' ) }
							onChange={ ( nextAlign ) => setAttributes( { numberAlign: { ...numberAlign, desktop: nextAlign } } ) }
							onChangeTablet={ ( nextAlign ) => setAttributes( { numberAlign: { ...numberAlign, tablet: nextAlign } } ) }
							onChangeMobile={ ( nextAlign ) => setAttributes( { numberAlign: { ...numberAlign, mobile: nextAlign } } ) }
						/>
