								...
								<ResponsiveAlignControls
									...
									onChange={(nextAlign) =>
										setAttributes({
											titleAlign: [
												nextAlign,
												titleAlign && titleAlign[1] ? titleAlign[1] : '',
												titleAlign && titleAlign[2] ? titleAlign[2] : '',
											],
										})
									}
									onChangeTablet={(nextAlign) =>
										setAttributes({
											titleAlign: [
												titleAlign && titleAlign[0] ? titleAlign[0] : '',
												nextAlign,
												titleAlign && titleAlign[2] ? titleAlign[2] : '',
											],
										})
						...
						<ResponsiveAlignControls
							...
							onChange={(nextAlign) =>
								setAttributes({
									numberAlign: [
										nextAlign,
										numberAlign && numberAlign[1] ? numberAlign[1] : '',
										numberAlign && numberAlign[2] ? numberAlign[2] : '',
									],
								})
							}
							onChangeTablet={(nextAlign) =>
								setAttributes({
									numberAlign: [
										numberAlign && numberAlign[0] ? numberAlign[0] : '',
										nextAlign,
										numberAlign && numberAlign[2] ? numberAlign[2] : '',
									],
								})
								...
								if (tab.name) {
									if ('mobile' === tab.name) {
										tabout = (
											<RangeControl
												value={
													undefined !== numberMinHeight && undefined !== numberMinHeight[2]
														? numberMinHeight[2]
														: ''
												}
												onChange={(value) =>
													setAttributes({
														numberMinHeight: [
															undefined !== numberMinHeight &&
															undefined !== numberMinHeight[0]
																? numberMinHeight[0]
																: '',
															undefined !== numberMinHeight &&
															undefined !== numberMinHeight[1]
																? numberMinHeight[1]
																: '',
															value,
														],
										...
										tabout = (
											<RangeControl
												value={
													undefined !== numberMinHeight && undefined !== numberMinHeight[1]
														? numberMinHeight[1]
														: ''
												}
												onChange={(value) =>
