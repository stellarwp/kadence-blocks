...
function Navigation( {
	...
	// - from an older version of navigation block added before the block used a kb_navigation entity.
	...
	useEffect( () => {
		...
		const subMenuElement = navRef.current?.querySelector(
			'[data-type="core/navigation-submenu"] [data-type="kadence/navigation-link"]'
		);
