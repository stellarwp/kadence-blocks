	...
	render() {
		const {
			attributes: {
				...
				revealOnLoad,
				evergreenStrict,
			}, setAttributes, className, clientId,
		} = this.props;
		const { previewExpired, borderWidthControl, borderRadiusControl, paddingControl, marginControl, itemBorderRadiusControl, itemPaddingControl, itemBorderWidthControl, activeTab } = this.state;
