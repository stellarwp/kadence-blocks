...
function KadenceForm( props ) {
	...
	const previewSubmitMarginTop = getPreviewSize( getPreviewDevice, ( undefined !== submitMargin && undefined !== submitMargin[ 0 ] && submitMargin[0].desk ? submitMargin[0].desk[ 0 ] : '' ), ( undefined !== submitMargin && undefined !== submitMargin[0] && submitMargin[0].tablet ? submitMargin[0].tablet[ 0 ] : '' ), ( undefined !== submitMargin && undefined !== submitMargin[ 0 ] && submitMargin[0].mobile ? submitMargin[0].mobile[ 0 ] : '' ) );
	const previewSubmitMarginRight = getPreviewSize( getPreviewDevice, ( undefined !== submitMargin && undefined !== submitMargin[ 0 ] && submitMargin[0].desk ? submitMargin[0].desk[ 1 ] : '' ), ( undefined !== submitMargin && undefined !== submitMargin[0] && submitMargin[0].tablet ? submitMargin[0].tablet[ 1 ] : '' ), ( undefined !== submitMargin && undefined !== submitMargin[ 0 ] && submitMargin[0].mobile ? submitMargin[0].mobile[ 1 ] : '' ) );
	const previewSubmitMarginBottom = getPreviewSize( getPreviewDevice, ( undefined !== submitMargin && undefined !== submitMargin[ 0 ] && submitMargin[0].desk ? submitMargin[0].desk[ 2 ] : '' ), ( undefined !== submitMargin && undefined !== submitMargin[0] && submitMargin[0].tablet ? submitMargin[0].tablet[ 2 ] : '' ), ( undefined !== submitMargin && undefined !== submitMargin[ 0 ] && submitMargin[0].mobile ? submitMargin[0].mobile[ 2 ] : '' ) );
	const previewSubmitMarginLeft = getPreviewSize( getPreviewDevice, ( undefined !== submitMargin && undefined !== submitMargin[ 0 ] && submitMargin[0].desk ? submitMargin[0].desk[ 3 ] : '' ), ( undefined !== submitMargin && undefined !== submitMargin[0] && submitMargin[0].tablet ? submitMargin[0].tablet[ 3 ] : '' ), ( undefined !== submitMargin && undefined !== submitMargin[ 0 ] && submitMargin[0].mobile ? submitMargin[0].mobile[ 3 ] : '' ) );

	const previewSubmitColumnWidth = getPreviewSize( getPreviewDevice, ( undefined !== submit && undefined !== submit[ 0 ] && submit[0].width ? submit[0].width[ 0 ] : '' ), ( undefined !== submit && undefined !== submit[ 0 ] && submit[0].width ? submit[0].width[ 1 ] : '' ), ( undefined !== submit && undefined !== submit[ 0 ] && submit[0].width ? submit[0].width[ 2 ] : '' ) );
	...
	const previewSubmitLineHeight = getPreviewSize( getPreviewDevice, ( undefined !== submitFont && undefined !== submitFont[ 0 ] && submitFont[0].lineHeight ? submitFont[0].lineHeight[ 0 ] : '' ), ( undefined !== submitFont && undefined !== submitFont[ 0 ] && submitFont[0].lineHeight ? submitFont[0].lineHeight[ 1 ] : '' ), ( undefined !== submitFont && undefined !== submitFont[ 0 ] && submitFont[0].lineHeight ? submitFont[0].lineHeight[ 2 ] : '' ) );
	...
	const fieldOutput = ( index ) => {
		...
		if ( fields[ index ].label && fields[ index ].label.includes( '{privacy_policy}' ) ) {
			...
			acceptLabel = (
				<>
					{acceptLabelBefore}<a href={( '' !== kadence_blocks_params.privacy_link ? kadence_blocks_params.privacy_link : '#' )} target="blank"
										  rel="noopener noreferrer">{( '' !== kadence_blocks_params.privacy_title ? kadence_blocks_params.privacy_title : 'Privacy policy' )}</a>{acceptLabelAfter}
				</>
			);
		} else {
					...
					<>
						{fields[ index ].showLink && (
							<a href={( undefined !== fields[ index ].default && '' !== fields[ index ].default ? fields[ index ].default : '#' )}
							   className={'kb-accept-link'}>{( undefined !== fields[ index ].placeholder && '' !== fields[ index ].placeholder ? fields[ index ].placeholder :
								<span className="kb-placeholder">{'View Privacy Policy'}</span> )}</a>
						)}
						<input type="checkbox" name={`kb_field_${index}`} id={`kb_field_${index}`} className={`kb-field kb-checkbox-style kb-${fields[ index ].type}`} value="accept"
						...
						}}>{( fields[ index ].label ? acceptLabel : <span className="kb-placeholder">{'Field Label'}</span> )} {( fields[ index ].required && style[ 0 ].showRequired ?
							<span className="required" style={{ color: KadenceColorOutput( style[ 0 ].requiredColor ) }}>*</span> : '' )}</label>
					</>
				)}
				{'accept' !== fields[ index ].type && (
					<>
						{fields[ index ].showLabel && (
							<label htmlFor={`kb_field_${index}`} style={{
								...
								marginBottom : ( '' !== labelFont[ 0 ].margin[ 2 ] ? labelFont[ 0 ].margin[ 2 ] + 'px' : undefined ),
								marginLeft   : ( '' !== labelFont[ 0 ].margin[ 3 ] ? labelFont[ 0 ].margin[ 3 ] + 'px' : undefined ),
							}}>{( fields[ index ].label ? fields[ index ].label : <span className="kb-placeholder">{'Field Label'}</span> )} {( fields[ index ].required && style[ 0 ].showRequired ?
								<span className="required" style={{ color: KadenceColorOutput( style[ 0 ].requiredColor ) }}>*</span> : '' )}</label>
						)}
						{'textarea' === fields[ index ].type && (
							<textarea name={`kb_field_${index}`} id={`kb_field_${index}`} type={fields[ index ].type} placeholder={fields[ index ].placeholder} value={fields[ index ].default}
									  data-type={fields[ index ].type} className={`kb-field kb-text-style-field kb-${fields[ index ].type}-field kb-field-${index}`} rows={fields[ index ].rows}
						...
						{'select' === fields[ index ].type && (
							<select name={`kb_field_${index}`} id={`kb_field_${index}`} type={fields[ index ].type} data-type={fields[ index ].type}
									multiple={( fields[ index ].multiSelect ? true : false )} className={`kb-field kb-select-style-field kb-${fields[ index ].type}-field kb-field-${index}`}
							...
							<div data-type={fields[ index ].type}
								...
								{times( fields[ index ].options.length, n => (
									<div key={n} data-type={fields[ index ].type} className={`kb-checkbox-item kb-checkbox-item-${n}`}>
										<input type="checkbox" name={`kb_field_${index}[]${n}`} id={`kb_field_${index}[]${n}`} className={'kb-sub-field kb-checkbox-style'}
											   value={( undefined !== fields[ index ].options[ n ].value ? fields[ index ].options[ n ].value : '' )}
							...
							<div data-type={fields[ index ].type}
								...
								{times( fields[ index ].options.length, n => (
									<div key={n} data-type={fields[ index ].type} className={`kb-radio-item kb-radio-item-${n}`}>
										<input type="radio" name={`kb_field_${index}[]${n}`} id={`kb_field_${index}[]${n}`} className={'kb-sub-field kb-radio-style'}
											   value={( undefined !== fields[ index ].options[ n ].value ? fields[ index ].options[ n ].value : '' )}
											   checked={( undefined !== fields[ index ].options[ n ].value && fields[ index ].options[ n ].value === fields[ index ].default ? true : false )} style={{
											borderColor: ( undefined === style[ 0 ].border ? undefined : KadenceColorOutput( style[ 0 ].border, ( style[ 0 ].borderOpacity !== undefined ? style[ 0 ].borderOpacity : 1 ) ) ),
										}}/>
