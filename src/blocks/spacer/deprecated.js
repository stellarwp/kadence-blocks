...
export default [
					...
					<div className={innerSpacerClasses}>
						{dividerEnable && (
							<>
								...
								{dividerStyle !== 'stripe' && <hr className="kt-divider" />}
							</>
						)}
					</div>
				</div>
	...
	},
	{
		...
		save: ({ attributes }) => {
			...
			const dividerBorderColor = !dividerColor
				? DeprecatedKadenceColorOutput('#eeeeee', alp)
				: DeprecatedKadenceColorOutput(dividerColor, alp);
			const getDataUri = () => {
				let svgStringPre = renderToString(
					<SvgPattern
						uniqueID={uniqueID}
						color={DeprecatedKadenceColorOutput(dividerColor)}
						opacity={dividerOpacity}
						rotate={rotate}
						strokeWidth={strokeWidth}
						strokeGap={strokeGap}
	...
	},
	{
		...
		save: ({ attributes }) => {
			...
			const dividerBorderColor = !dividerColor
				? DeprecatedKadenceColorOutput('#eeeeee', dividerOpacity)
				: DeprecatedKadenceColorOutput(dividerColor, dividerOpacity);
			return (
	...
	},
	{
		...
		save: ({ attributes }) => {
			...
			const dividerBorderColor = !dividerColor
				? DeprecatedKadenceColorOutput('#eee', dividerOpacity)
				: DeprecatedKadenceColorOutput(dividerColor, dividerOpacity);
			return (
				<div className={`align${blockAlignment}`}>
					<div
