	...
	return (
		<div {...blockProps}>
				...
				{activeTab === 'general' && (
					<>
						...
						>
							...
							{isOpen && (
								<Modal title={__('Add New', 'kadence-blocks')} onRequestClose={closeModal} shouldCloseOnClickOutside={false}>
			...
			<div className={containerClasses}>
				{id && id > 0 ? (
					isLoading ? (
						<div className="kb-vector-loading">
							{__('Loading SVG...', 'kadence-blocks')}
						</div>
					) : (
