...
registerBlockType('kadence/accordion', {
	...
	keywords: [__('accordion', 'kadence-blocks'), __('pane', 'kadence-blocks'), 'KB'],
	icon: {
		...
		innerBlocks: [
			{
				...
				attributes: {
					id: 1,
					title: [__('First Heading', 'kadence-blocks')],
				},
				innerBlocks: [
					{
						name: 'core/paragraph',
						attributes: {
							content: __(
								'This is an example of an accordion. You can add any block to the accordion pane. You can also add multiple panes to the accordion.',
								'kadence-blocks'
							),
						},
					},
			...
			},
			{
				...
				attributes: {
					id: 2,
					title: [__('Second Heading', 'kadence-blocks')],
				},
				innerBlocks: [
					{
						name: 'core/paragraph',
