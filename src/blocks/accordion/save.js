...
function KadenceAccordionSave({ attributes }) {
	...
	const innerClasses = classnames(
		`kt-accordion-wrap kt-accordion-id${uniqueID} kt-accordion-has-${paneCount}-panes kt-active-pane-${openPane} kt-accordion-block kt-pane-header-alignment-${
			titleAlignment ? titleAlignment : 'left'
		} kt-accodion-icon-style-${iconStyle && showIcon ? iconStyle : 'none'} kt-accodion-icon-side-${
