			...
			<Fragment>
				...
				{ this.showSettings( 'paddingMargin' ) && (
					<PanelBody
						...
						initialOpen={ false }
					>
						<h2>{ __( 'Padding (px)', 'kadence-blocks' ) }</h2>
						<RangeControl
