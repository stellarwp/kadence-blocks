<?php
/**
 * Server-side registering and rendering of the `kadence/navigation-link` block.
 *
 * @package WordPress
 */
...
/**
 * Renders the `kadence/navigation-link` block.
 *
...
function block_core_navigation_link_register_variation( $variation ) {
	...
	$navigation_block_type = WP_Block_Type_Registry::get_instance()->get_registered( 'kadence/navigation-link' );
