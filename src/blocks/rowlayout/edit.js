...
function RowLayoutEditContainer( props ) {
	...
	useEffect( () => {
		...
		if ( '' !== topMarginT || '' !== bottomMarginT ) {
			setAttributes( {
				tabletMargin: [
					'' !== topMarginT ? topMarginT : '',
					'',
					'' !== bottomMarginT ? bottomMarginT : '',
					'',
				],
				topMarginT: '',
				bottomMarginT: '',
									...
									<>
										...
										>
											...
											<ToggleControl
												...
												checked={
													undefined !== columnsInnerHeight ? columnsInnerHeight : false
												}
											...
											{ kadence_blocks_params && kadence_blocks_params.rcp_access && (
												<>
													<ToggleControl
														...
														onChange={ ( value ) =>
															setAttributes( { rcpMembership: value } )
														}
													/>
													{ rcpMembership && (
														<>
