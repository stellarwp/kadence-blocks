 ...
 */
 function LayoutControls( {
	...
	if ( 2 === columns ) {
		...
		layoutOptions = [
			{ value: 'equal', label: __( 'Single Row', 'kadence-blocks' ), icon: rowIcon },
		];
	}
	if ( 2 === columns ) {
		mobileLayoutOptions = [
		...
		mobileLayoutOptions = [
			{ value: 'row', label: __( 'Single Row', 'kadence-blocks' ), icon: rowIcon },
		];
	}
