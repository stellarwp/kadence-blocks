			...
			<div {...blockProps}>
					...
					{activeTab === 'general' && (
						<>
							<KadencePanelBody
								...
								initialOpen={true}
								panelName={'kb-adv-form-time-controls'}
							>
								<ToggleControl
					...
					{activeTab === 'advanced' && (
						<>
							<KadencePanelBody
								...
								initialOpen={true}
								panelName={'kb-adv-form-time-width'}
							>
								<ResponsiveRangeControls
				...
				<>
					<FormFieldLabel
						...
						name={name}
					/>
					<input type={'time'} className={'kb-field'} value={defaultPreview} onChange={(value) => false} />
