...
function FieldEmail( { attributes, setAttributes, isSelected, name, previewDevice, context  } ) {
	const { required, label, showLabel, value, helpText, width, ariaDescription, placeholder, textColor } = attributes;
	...
	const helpStyles = GetHelpStyles( previewDevice, parentLabelStyle );
