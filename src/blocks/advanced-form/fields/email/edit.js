...
function FieldEmail( { attributes, setAttributes, isSelected, clientId, context, name  } ) {
			...
			<div {...blockProps}>
				...
				<InspectorControls>
					<InspectorControlTabs
						panelName={'advanced-form-email-general'}
					...
					{ ( activeTab === 'general' ) &&
						<>
							<KadencePanelBody
								...
								initialOpen={true}
								panelName={ 'kb-adv-form-email-controls' }
							>
								<ToggleControl
					...
					{ ( activeTab === 'advanced' ) &&
						<>
							<KadencePanelBody
								...
								initialOpen={true}
								panelName={ 'kb-adv-form-email-width' }
							>
							...
							<KadencePanelBody
								...
								initialOpen={false}
								panelName={ 'kb-adv-form-email-extra-settings' }
							>
								<FieldName
									value={inputName}
									uniqueID={uniqueID}
