			...
			<div {...blockProps}>
					...
					{activeTab === 'general' && (
						<>
							<KadencePanelBody
								...
								initialOpen={true}
								panelName={'kb-adv-form-date-controls'}
							>
								<ToggleControl
					...
					{activeTab === 'advanced' && (
						<>
							...
							<KadencePanelBody
								...
								initialOpen={false}
								panelName={'kb-adv-form-date-extra-settings'}
							>
								<FieldName
									value={inputName}
									uniqueID={uniqueID}
				...
				<>
					<FormFieldLabel
						...
						name={name}
					/>
					<input type={'date'} className={'kb-field'} value={defaultPreview} onChange={(value) => false} />
