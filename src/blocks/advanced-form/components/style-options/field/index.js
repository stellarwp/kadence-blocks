...
import { RangeControl, ButtonGroup, Button, Dashicon, TabPanel, SelectControl } from '@wordpress/components';
			...
			<ResponsiveGapSizeControl
				...
				onChange={(value) =>
					saveStyle({
						gap: [
							value,
							undefined !== style?.gap?.[1] ? style.gap[1] : '',
							undefined !== style?.gap?.[2] ? style.gap[2] : '',
						],
					})
				}
				...
				onChangeTablet={(value) =>
					saveStyle({
						gap: [
							undefined !== style?.gap?.[0] ? style.gap[0] : '',
							value,
							undefined !== style?.gap?.[2] ? style.gap[2] : '',
						],
					})
				...
				hover={
					<>
						...
						<BoxShadowControl
							...
							enable={
								undefined !== style?.boxShadowActive && undefined !== style.boxShadowActive[0]
									? style.boxShadowActive[0]
									: false
							}
							color={
								undefined !== style?.boxShadowActive && undefined !== style.boxShadowActive[1]
									? style.boxShadowActive[1]
									: '#000000'
							}
							default={'#000000'}
							opacity={
								undefined !== style?.boxShadowActive && undefined !== style.boxShadowActive[2]
									? style.boxShadowActive[2]
									: 0.4
							}
							hOffset={
								undefined !== style?.boxShadowActive && undefined !== style.boxShadowActive[3]
									? style.boxShadowActive[3]
									: 2
							}
							vOffset={
								undefined !== style?.boxShadowActive && undefined !== style.boxShadowActive[4]
									? style.boxShadowActive[4]
									: 2
							}
							blur={
								undefined !== style?.boxShadowActive && undefined !== style.boxShadowActive[5]
									? style.boxShadowActive[5]
									: 3
							}
							spread={
								undefined !== style?.boxShadowActive && undefined !== style.boxShadowActive[6]
									? style.boxShadowActive[6]
									: 0
							}
							inset={
								undefined !== style?.boxShadowActive && undefined !== style.boxShadowActive[7]
									? style.boxShadowActive[7]
									: false
							}
				...
				normal={
					<>
						...
						<BoxShadowControl
							...
							enable={
								undefined !== style?.boxShadow && undefined !== style?.boxShadow[0]
									? style.boxShadow[0]
									: false
							}
							color={
								undefined !== style?.boxShadow && undefined !== style?.boxShadow[1]
									? style.boxShadow[1]
									: '#000000'
							}
							default={'#000000'}
							opacity={
								undefined !== style?.boxShadow && undefined !== style?.boxShadow[2]
									? style.boxShadow[2]
									: 0.4
							}
							hOffset={
								undefined !== style?.boxShadow && undefined !== style?.boxShadow[3]
									? style.boxShadow[3]
									: 2
							}
							vOffset={
								undefined !== style?.boxShadow && undefined !== style?.boxShadow[4]
									? style.boxShadow[4]
									: 2
							}
							blur={
								undefined !== style?.boxShadow && undefined !== style?.boxShadow[5]
									? style.boxShadow[5]
									: 3
							}
							spread={
								undefined !== style?.boxShadow && undefined !== style?.boxShadow[6]
									? style.boxShadow[6]
									: 0
							}
							inset={
								undefined !== style?.boxShadow && undefined !== style?.boxShadow[7]
									? style.boxShadow[7]
									: false
							}
							onEnableChange={(value) => {
