								...
								tabout = (
									<Fragment>
										<SelectControl
											...
											onChange={value => {
												saveSubmit( { width: [ ( submit.width[ 0 ] ? submit.width[ 0 ] : '100' ), ( submit.width[ 1 ] ? submit.width[ 1 ] : '' ), value ] } );
											}}
										/>
									</Fragment>
								);
								...
								tabout = (
									<Fragment>
										<SelectControl
											...
											onChange={value => {
												saveSubmit( { width: [ ( submit.width[ 0 ] ? submit.width[ 0 ] : '100' ), value, ( submit.width[ 2 ] ? submit.width[ 2 ] : '' ) ] } );
											}}
										/>
									</Fragment>
								);
								...
								tabout = (
									<Fragment>
										<SelectControl
											...
											onChange={value => {
												saveSubmit( { width: [ value, ( submit.width[ 1 ] ? submit.width[ 1 ] : '' ), ( submit.width[ 2 ] ? submit.width[ 2 ] : '' ) ] } );
											}}
										/>
									</Fragment>
								);
