...
import { TabPanel, Dashicon, SelectControl, ExternalLink, TextControl } from '@wordpress/components';
					...
					if ('mobile' === tab.name) {
						tabout = (
							<SelectControl
								...
								onChange={(value) => {
									saveSubmit({
										width: [width[0] ? width[0] : '100', width[1] ? width[1] : '', value],
									});
								}}
							/>
						);
						...
						tabout = (
							<SelectControl
								...
								onChange={(value) => {
									saveSubmit({
										width: [width[0] ? width[0] : '100', value, width[2] ? width[2] : ''],
									});
								}}
							/>
						);
