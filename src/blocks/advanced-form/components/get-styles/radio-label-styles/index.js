...
export default (previewDevice, radioLabelFont) => {
	...
	styles.fontSize = getFontSizeOptionOutput(
		getPreviewSize(previewDevice, radioLabelFont.size[0], radioLabelFont.size[1], radioLabelFont.size[2]),
	...
	let letterSpacing = getPreviewSize(
		...
		radioLabelFont?.letterSpacing?.[2]
	);
	if (letterSpacing) {
