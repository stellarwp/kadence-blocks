...
export function migrateToInnerblocks( attributes ) {
	...
	times( btnCount, n => {
		...
		if ( undefined !== newAttrs?.backgroundType && 'gradient' === newAttrs.backgroundType ) {
			let btnbg = '';
			const btnGrad = ( undefined === newAttrs.background ? KadenceColorOutput( '#444444', ( newAttrs.backgroundOpacity !== undefined ? newAttrs.backgroundOpacity : 1 ) ) : KadenceColorOutput( newAttrs.background, ( newAttrs.backgroundOpacity !== undefined ? newAttrs.backgroundOpacity : 1 ) ) );
			const btnGrad2 = ( undefined === newAttrs.gradient[ 0 ] ? KadenceColorOutput( '#777777', ( newAttrs.gradient[ 1 ] !== undefined ? newAttrs.gradient[ 1 ] : 1 ) ) : KadenceColorOutput( newAttrs.gradient[ 0 ], ( newAttrs.gradient[ 1 ] !== undefined ? newAttrs.gradient[ 1 ] : 1 ) ) );
