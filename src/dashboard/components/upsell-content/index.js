...
export function UpsellContent({
	...
	return (
		<div
			className={`kb-upsell-content ${
				flip ? "kb-upsell-content--flipped" : ""
			}`}
		>
			...
			<div className="kb-upsell-content__container">
				...
				{description && (
					<div className="kb-upsell-content__description">{description}</div>
				)}
				{href && buttonText && (
					<DashboardButton variant="primary" text={buttonText} href={href} />
				)}
			</div>
		</div>
	);
