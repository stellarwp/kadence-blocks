<?php
if ( !class_exists('Kadence_Puc_Plugin_UpdateChecker', false) ):
	 ...
	 * @access public
	 */
	class Kadence_Puc_Plugin_UpdateChecker extends Kadence_Puc_UpdateChecker {
		...
		/**
		 * @var Kadence_Puc_Plugin_Package
		 */
		protected $package;
		...
		public function __construct($metadataUrl, $pluginFile, $slug = '', $checkPeriod = 12, $optionName = '', $muPluginFile = ''){
			...
			$this->extraUi = new Kadence_Puc_Plugin_Ui($this);
		}
		 ...
		 * @return Kadence_Puc_Scheduler
		 */
		protected function createScheduler($checkPeriod) {
			$scheduler = new Kadence_Puc_Scheduler($this, $checkPeriod, array('load-plugins.php'));
		 ...
		 * @return Kadence_Puc_Plugin_Info
		 */
		public function requestInfo($queryArgs = array()) {
			list($pluginInfo, $result) = $this->requestMetadata('Kadence_Puc_Plugin_Info', 'request_info', $queryArgs);

			if ( $pluginInfo !== null ) {
				/** @var Kadence_Puc_Plugin_Info $pluginInfo */
		 ...
		 *
		 * @return Kadence_Puc_Update|null An instance of Plugin_Update, or NULL when no updates are available.
		 */
		public function requestUpdate() {
			...
			$update = Kadence_Puc_Plugin_Update::fromPluginInfo($pluginInfo);
		 ...
		 *
		 * @return Kadence_Puc_Plugin_Update|null
		 */
		public function getUpdate() {
			$update = parent::getUpdate();
			if ( isset($update) ) {
				/** @var Kadence_Puc_Plugin_Update $update */
		 ...
		 *
		 * @return Kadence_Puc_InstalledPackage
		 */
		protected function createInstalledPackage() {
			return new Kadence_Puc_Plugin_Package($this->pluginAbsolutePath, $this);
		}

		/**
		 * @return Kadence_Puc_Plugin_Package
		 */
