<?php
if ( !class_exists('Kadence_Puc_Plugin_Package', false) ):

	class Kadence_Puc_Plugin_Package extends Kadence_Puc_InstalledPackage {
		/**
		 * @var Kadence_Puc_Plugin_UpdateChecker
		 */
		...
		public function isMuPlugin() {
			...
			if ( $cachedResult === null ) {
				...
				if (($muPluginDir === false) || ($pluginPath === false)) {
					$muPluginDir = Kadence_Update_Checker::normalizePath(WPMU_PLUGIN_DIR);
					$pluginPath  = Kadence_Update_Checker::normalizePath($this->pluginAbsolutePath);
				}
