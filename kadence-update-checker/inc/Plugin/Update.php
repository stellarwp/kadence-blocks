<?php
if ( !class_exists('Kadence_Puc_Plugin_Update', false) ):
	 ...
	 * @access public
	 */
	class Kadence_Puc_Plugin_Update extends Kadence_Puc_Update {
		public $id = 0;
		public $homepage;
		...
		public static function fromJson($json){
			...
			$pluginInfo = Kadence_Puc_Plugin_Info::fromJson($json);
			if ( $pluginInfo !== null ) {
		 ...
		 *
		 * @param Kadence_Puc_Plugin_Info $info
		 * @return Kadence_Puc_Plugin_Update
		 */
		 ...
		 *
		 * @param StdClass|Kadence_Puc_Plugin_Info|Kadence_Puc_Plugin_Update $object The source object.
		 * @return Kadence_Puc_Plugin_Update The new copy.
		 */
