...
if ( !class_exists('Kadence_Puc_StateStore', false) ):

	class Kadence_Puc_StateStore {
		/**
		...
		/**
		 * @var Kadence_Puc_Update|null Cached update.
		 */
		...
		/**
		 * @return null|Kadence_Puc_Update
		 */
		 ...
		 * @return $this
		 */
		public function setUpdate(Kadence_Puc_Update $update = null) {
			$this->lazyLoad();
			$this->update = $update;
			return $this;
		}
		...
		public function save() {
			...
			if ( isset($this->update)) {
				...
				if ( Kadence_Puc_Utils::startsWith($updateClass, $prefix) ) {
		...
		protected function load() {
			...
			$this->lastCheck = intval(Kadence_Puc_Utils::get($state, 'lastCheck', 0));
			$this->checkedVersion = Kadence_Puc_Utils::get($state, 'checkedVersion', '');
			$this->update = null;
