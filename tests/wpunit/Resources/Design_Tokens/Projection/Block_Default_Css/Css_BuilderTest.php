...
final class Css_BuilderTest extends TestCase {
	 ...
	 * `kadence/single-icon` child block — ever registers a preset set for `kadence/icon` and the builder
	 ...
	 *
	 * @param Token_Registry $registry The registry whose preset sets the builder reads.
	 *
	 * @return Css_Builder
	 */
	...
	/**
	 * A registry holding the media-radius token and the Image preset set binding borderRadius to it via a
