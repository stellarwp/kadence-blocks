 ...
 * from the tokens, is a no-op when the registry is deactivated, and honors the active library — only the
 * active library is emitted, so pointing the active-library pointer at another library changes what is
...
final class ProjectorTest extends TestCase {
	...
	/**
	 * Only the active library is emitted: pointing the active-library pointer at brand-b projects brand-b's
	 * literal under the canonical button var, and the non-active default library's literal is absent.
	 *
	 * @return void
	 */
