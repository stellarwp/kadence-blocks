...
final class Preset_ResolverTest extends TestCase {
	...
	public function testTheShippedButtonSetIsConsistent(): void {
		...
		$this->assertNotNull( $set, 'The Button preset bindings should be registered at boot.' );
	...
	/**
	 * The Advanced Text (heading) preset bindings are registered at boot and its $default resolves the full
