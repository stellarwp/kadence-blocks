...
final class BackgroundLazyLoaderTest extends TestCase {
	...
	public function testItReturnsOriginalArgsWhenNoBackgroundImageAndNoSlider(): void {
		$args = [
			'class' => 'kb-row-layout',
			'id'    => 'test-row',
		];
	...
	public function testItReturnsOriginalArgsWhenNoBackgroundImageAndEmptyClasses(): void {
		$args = [
			'id' => 'test-row',
		];
	...
	public function testItReturnsOriginalArgsWhenNoBackgroundImageAndFalseClasses(): void {
		$args = [
			'class' => false,
			'id'    => 'test-row',
		];
	...
	public function testItAddsLazyLoadingAttributesWhenNoBackgroundImageButHasSlider(): void {
		$args = [
			'class' => 'kb-row-layout kb-row-has-slider',
			'id'    => 'test-row',
		];
		...
		$expected = [
			'id'                        => 'test-row',
			'data-kadence-lazy-class'   => 'kb-row-layout kb-row-has-slider',
			'data-kadence-lazy-trigger' => 'viewport',
			'data-kadence-lazy-attrs'   => 'class',
		];
	...
	public function testItAddsLazyLoadingAttributesWhenNoBackgroundImageButHasSliderOnly(): void {
		$args = [
			'class' => 'kb-row-has-slider',
			'id'    => 'test-row',
		];
		...
		$expected = [
			'id'                        => 'test-row',
			'data-kadence-lazy-class'   => 'kb-row-has-slider',
			'data-kadence-lazy-trigger' => 'viewport',
			'data-kadence-lazy-attrs'   => 'class',
		];
	...
	public function testItAddsLazyLoadingAttributesWhenNoBackgroundImageButHasSliderWithOtherClasses(): void {
		$args = [
			'class' => 'kb-row-layout kb-row-has-slider custom-class',
			'id'    => 'test-row',
		];
		...
		$expected = [
			'id'                        => 'test-row',
			'data-kadence-lazy-class'   => 'kb-row-layout kb-row-has-slider custom-class',
			'data-kadence-lazy-trigger' => 'viewport',
			'data-kadence-lazy-attrs'   => 'class',
		];
	...
	public function testItAddsLazyLoadingAttributesWhenHasBackgroundImageAndSlider(): void {
		$args = [
			'class' => 'kb-row-layout kb-row-has-slider',
			'id'    => 'test-row',
		];
	...
	public function testItAddsLazyLoadingAttributesWhenHasBackgroundImageAndSliderWithInlineStyle(): void {
		$args = [
			'class' => 'kb-row-layout kb-row-has-slider',
			'style' => 'background-image: url(http://wordpress.test/image.jpg);',
			'id'    => 'test-row',
	...
	public function testItHandlesSliderClassWithWhitespace(): void {
		$args = [
			'class' => '   kb-row-has-slider   ',
			'id'    => 'test-row',
		];
	...
	public function testItHandlesSliderClassCaseSensitivity(): void {
		$args = [
			'class' => 'kb-row-layout KB-ROW-HAS-SLIDER',
			'id'    => 'test-row',
		];
		...
		// Should NOT add lazy loading attributes since the case doesn't match.
		$this->assertEquals( $args, $result );
	}

	public function testItHandlesSliderClassAsPartialMatch(): void {
		$args = [
			'class' => 'kb-row-layout kb-row-has-slider-extra',
			'id'    => 'test-row',
		];
		...
		// Should add lazy loading attributes since it contains the slider class.
		$expected = [
			'id'                        => 'test-row',
			'data-kadence-lazy-class'   => 'kb-row-layout kb-row-has-slider-extra',
			'data-kadence-lazy-trigger' => 'viewport',
			'data-kadence-lazy-attrs'   => 'class',
		];
	...
	public function testItReturnsOriginalArgsWhenSliderClassWithBackgroundImageAboveTheFold(): void {
		$args = [
			'class' => 'kb-row-layout kb-row-has-slider',
			'id'    => 'test-row',
		];
		...
		// Should return original args because the background image is above the fold, even with slider class.
		$this->assertEquals( $args, $result );
	}

	public function testItPreservesOtherAttributesWhenAddingLazyLoadingForSlider(): void {
		$args = [
			'class'     => 'kb-row-layout kb-row-has-slider',
			'id'        => 'test-row',
			'style'     => 'background-color: red;',
