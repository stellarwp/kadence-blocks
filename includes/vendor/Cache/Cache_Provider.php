...
final class Cache_Provider extends Provider {
	...
	private function register_block_library_storage(): void {
		...
		add_action( 'shutdown', $this->container->callback( Block_Library_Cache::class, 'write' ), PHP_INT_MAX - 1 );
	}
	...
	private function register_ai_storage(): void {
		...
		add_action( 'shutdown', $this->container->callback( Ai_Cache::class, 'write' ), PHP_INT_MAX - 1 );
	}
