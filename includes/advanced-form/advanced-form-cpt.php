...
class Kadence_Blocks_Form_CPT_Controller {
	...
	public function register_post_type() {
		$labels  = array(
			'name'               => _x( 'Forms', 'Post Type General Name', 'kadence-blocks' ),
			'singular_name'      => _x( 'Form', 'Post Type Singular Name', 'kadence-blocks' ),
			'menu_name'          => __( 'Forms', 'kadence-blocks' ),
			'menu_name'          => _x( 'Forms', 'Admin Menu text', 'kadence-blocks' ),
			'archives'           => __( 'Form Archives', 'kadence-blocks' ),
			'attributes'         => __( 'Form Attributes', 'kadence-blocks' ),
			...
			'view_item'          => __( 'View Form', 'kadence-blocks' ),
			'view_items'         => __( 'View Forms', 'kadence-blocks' ),
			'search_items'       => __( 'Search Forms', 'kadence-blocks' ),
