...
class Kadence_Blocks_Advancedheading_Block extends Kadence_Blocks_Abstract_Block {
	...
	public function build_css( $attributes, $css, $unique_id, $unique_style_id ) {
		...
		if( isset($attributes['enableTextOrientation']) ) {
			$css->add_property( 'writing-mode', ( isset($attributes['textWritingMode']) ? $attributes['textWritingMode'] : 'vertical-lr' ) );
			$css->add_property( 'text-orientation', ( isset($attributes['textOrientation']) ? $attributes['textOrientation'] : 'mixed' ) );
		}
