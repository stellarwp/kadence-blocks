...
class Kadence_Blocks_Advancedgallery_Block extends Kadence_Blocks_Abstract_Block {
	...
	public function render_gallery_images( $image, $attributes ) {
		...
		$caption       = strip_tags( html_entity_decode(is_string($caption) ? $caption : '', ENT_QUOTES, 'UTF-8') );
		$href = '';
		...
		$figcap = '<' . $fig_tag . ' class="kadence-blocks-gallery-item__caption">' . ( ! empty( $caption ) && is_string( $caption ) ? esc_attr( $caption ) : '' ) . '</' . $fig_tag . '>';
