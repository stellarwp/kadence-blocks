...
class Kadence_Blocks_Rowlayout_Block extends Kadence_Blocks_Abstract_Block {
	...
	public function get_video_render( $attributes ) {
		...
		$show_audio = ( $show_audio_is_default && $show_play_pause && isset( $video_attributes['mute'] ) && false === $video_attributes['mute'] ) || ( isset( $video_attributes['btnsMute'] ) && $video_attributes['btnsMute'] );
		if ( $show_play_pause || $show_audio ) {
