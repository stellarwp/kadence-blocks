...
if ( !class_exists('Kadence_Puc_Theme_UpdateChecker', false) ):

	class Kadence_Puc_Theme_UpdateChecker extends Kadence_Puc_UpdateChecker {
		 ...
		 *
		 * @return Kadence_Puc_Update|null An instance of Update, or NULL when no updates are available.
		 */
		public function requestUpdate() {
			list($themeUpdate, $result) = $this->requestMetadata('Kadence_Puc_Theme_Update', 'request_update');

			if ( $themeUpdate !== null ) {
				/** @var Kadence_Puc_Theme_Update $themeUpdate */
		...
		protected function createScheduler($checkPeriod) {
			return new Kadence_Puc_Scheduler($this, $checkPeriod, array('load-themes.php'));
		}
		...
		protected function createInstalledPackage() {
			return new Kadence_Puc_Theme_Package($this->stylesheet, $this);
		}
	}
