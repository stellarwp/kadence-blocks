...
if ( !class_exists('Kadence_Puc_Theme_Update', false) ):

	class Kadence_Puc_Theme_Update extends Kadence_Puc_Update {
		public $details_url = '';
		 ...
		 *
		 * @param StdClass|Kadence_Puc_Theme_Update $object The source object.
		 * @return Kadence_Puc_Theme_Update The new copy.
		 */
