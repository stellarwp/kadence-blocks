...
if ( !class_exists('Kadence_Puc_UpdateChecker', false) ):

	abstract class Kadence_Puc_UpdateChecker {
		...
		/**
		 * @var Kadence_Puc_InstalledPackage
		 */
		protected $package;

		/**
		 * @var Kadence_Puc_Scheduler
		 */
		public $scheduler;

		/**
		 * @var Kadence_Puc_UpgraderStatus
		 */
		protected $upgraderStatus;

		/**
		 * @var Kadence_Puc_StateStore
		 */
		...
		public function __construct($metadataUrl, $directoryName, $slug = null, $checkPeriod = 2, $optionName = '') {
			...
			$this->upgraderStatus = new Kadence_Puc_UpgraderStatus();
			$this->updateState = new Kadence_Puc_StateStore($this->optionName);
		 ...
		 *
		 * @return Kadence_Puc_Update|null
		 */
		 ...
		 *
		 * @return Kadence_Puc_Update An instance of Update, or NULL when no updates are available.
		 */
		 ...
		 *
		 * @param Kadence_Puc_Metadata|null $update
		 */
		protected function fixSupportedWordpressVersion(Kadence_Puc_Metadata $update = null) {
		 ...
		 * @return array [Kadence_Puc_Metadata|null, array|WP_Error] A metadata instance and the value returned by wp_remote_get().
		 */
