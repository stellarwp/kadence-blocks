...
/**
 * Validates a borderStyle $value: an alias or a borderStyle literal.
 *
 * @since TBD
 */
final class Border_Style_Value implements Value_Validator {

	/**
	 * Validate a borderStyle $value.
	 *
	 * @since TBD
	 *
	...
	public function validate( $value, string $path ): array {
		return Kind::validate( Token_Type::get_type_border_style(), $value, $path );
	}
}
