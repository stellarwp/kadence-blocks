...
/**
 * WordPress hook callbacks for the CSS-variable backbone.
 *
 * Injects --kb-token--* / --wp--preset--* into KB's existing inline styles and
 * feeds the legacy color/font-size filters — all gated on
...
final class Hooks {
	...
	private function build_css(): string {
		...
		return $this->projector->css_for_version( $resolved, $version );
	}
