...
/**
 * Reads the effective colorPalettes section: the shipped baseline's palettes deep-merged with a library's
 * stored overrides, so a palette authored through the store is visible alongside the baseline ones.
 *
