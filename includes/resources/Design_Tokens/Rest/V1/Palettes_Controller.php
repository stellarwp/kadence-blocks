...
final class Palettes_Controller extends Controller {
	...
	public function update_item( $request ) {
		...
		// has a shorter/reordered groups list than the one already stored, and a plain merge index-merges the two
		// lists positionally — leaving stale groups/swatches behind. This is the same guard the swatch write path
		// relies on, so both routes converge on {@see write_palette_node()}.
