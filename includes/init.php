...
//		'template_lock'         => 'insert',
		...
		'labels'                => [
			...
			'featured_image'        => __( 'Featured Image', 'kadence_blocks' ),
			'set_featured_image'    => __( 'Set featured image', 'kadence_blocks' ),
			'remove_featured_image' => __( 'Remove featured image', 'kadence_blocks' ),
			'use_featured_image'    => __( 'Use as featured image', 'kadence_blocks' ),
			'insert_into_item'      => __( 'Insert into Kadence Form', 'kadence_blocks' ),
			'uploaded_to_this_item' => __( 'Uploaded to this item', 'kadence_blocks' ),
			'items_list'            => __( 'Kadence Forms list', 'kadence_blocks' ),
			'items_list_navigation' => __( 'Kadence Forms list navigation', 'kadence_blocks' ),
