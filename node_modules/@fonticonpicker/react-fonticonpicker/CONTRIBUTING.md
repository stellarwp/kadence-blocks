...
The [README](README.md#development-environment) has a comprehensive guide on how to setup this project
locally on your machine. A `TL;DR` version is

1. Install Nodejs >= 9 ( 8 may also work ).
2. Clone this repo.
