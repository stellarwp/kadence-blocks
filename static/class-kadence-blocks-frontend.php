...
class Kadence_Blocks_Frontend {
	...
	public function register_scripts() {
		...
		wp_register_style( 'kadence-blocks-rowlayout', KADENCE_BLOCKS_URL . 'dist/blocks/row-layout.style.build.css', array(), KADENCE_BLOCKS_VERSION );
		...
		wp_register_script( 'kadence-blocks-google-maps-init-js', KADENCE_BLOCKS_URL . 'dist/assets/js/kb-init-google-maps.min.js', array(), KADENCE_BLOCKS_VERSION, true );
